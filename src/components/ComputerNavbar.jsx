...
const ComputerNavbar = () => {
  ...
  return (
    <div className='w-full h-[100px] flex justify-between items-center px-[20px] bg-[var(--primary2)]'>
        <div className='w-[10%]'>
            <h1 className={`${laila.className} text-white  text-2xl cursor-pointer`} >Desi Market</h1>
        </div>
        <div className='w-[60%] flex justify-center items-center'>
            <div className='w-[60%]'>
                <input className='w-full rounded-2xl px-[10px] py-[5px]' type='text' placeholder='Search Products here'/>
            </div>
        </div>
        <div className='w-[30%] flex justify-end items-center gap-[10px]'>
            <div className='w-[15%] bg-white text-[var(--primary1)] flex justify-center items-center py-[2px] rounded-sm' onClick={() => router.push('/auth/login')}>
